...
export const navbarLinks: NavLink[] = [
  ...
  { id: 2, path: '/jobs', label: 'jobs' },
  { id: 3, path: '/jobs/add', label: 'add jobs' },
];
...
export const homeCards: Card[] = [
  {
    ...
    subTitle: 'Browse our Angular jobs and start your career today',
    link: { path: '/jobs', label: ' Browse Jobs' },
    isAccent: false,
  },
  {
    id: 2,
    ...
    link: { path: '/jobs/add', label: 'Add Job' },
    isAccent: true,
  },
];
...
export const jobs: JobListing[] = [
  {
    ...
    location: 'Boston, MA',
    description:
      'We are seeking a talented Front-End Developer to join our team in Boston, MA. The ideal candidate will have strong skills in HTML, CSS, and JavaScript, with experience working with modern JavaScript frameworks such as Angular or Angular.',
    salary: '$90K - $100K',
    company: {
  ...
  {
    id: '2',
    title: 'Front-End Engineer (Angular, React)',
    type: 'Full-Time',
    description:
